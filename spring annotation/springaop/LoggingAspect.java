...
public class LoggingAspect {
	@Before("execution(* springaop.CustomerBo.addCustomer(..))") 
	...
	@After("execution(* springaop.CustomerBo.addCustomer(..))")
	...
	@AfterReturning(pointcut = "execution(* springaop.CustomerBo.addCustomerReturnValue(..))", returning="result")
	...
	@AfterThrowing( pointcut = "execution(* springaop.CustomerBo.addCustomerThrowException(..))", throwing= "error") 
	...
	@Around("execution(* springaop.CustomerBo.addCustomerAround(..))")
