...
@WebServlet(name = "ActionServlet", urlPatterns = {"/ActionServlet", "*.do"}, initParams = {
	    @WebInitParam(name = "config", value = "/WEB-INF/config.properties"),@WebInitParam(name="dbconfig",value="/WEB-INF/dbconfig.properties")
})
